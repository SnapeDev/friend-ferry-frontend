  ...
  return (
    <div className="p-6 max-w-4xl mx-auto text-left">
      ...
      <p className="mb-4">
        ...
        access request is by contacting us at Friend Ferry ltd. We will consider
      ...
      <ul className="list-disc pl-5 mb-4">
        ...
        <li>
          <strong>To fulfil and manage your orders.</strong> We may process your
      ...
      <p className="mb-4">
        ...
        contacting us by using the contact details provided on this page.
      </p>
      ...
      <p className="mb-4">
        ...
        time by contacting us by using the contact details provided on this
        page.
      </p>
      ...
      <p className="mb-4">
        ...
        admin@friendferry.com or contact us by post at:
      </p>
      ...
      <p className="mb-4">
        ...
        request by contacting us at admin@friendferry.com.
      </p>
    </div>
  );
}
